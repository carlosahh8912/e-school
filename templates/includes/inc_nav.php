...
<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
        ...
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
            <!--begin::Heading-->
            <h1 class="text-dark fw-bolder my-1 fs-2">Bienvenido a E-School
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                <li class="breadcrumb-item text-muted">
                    <a href="dashboard" class="text-muted">Inicio</a>
                </li>
                <?php
                    if(isset($d->page)){
                        echo '<li class="breadcrumb-item text-muted"><a href="'.$d->slug.'" class="text-muted">'.$d->page.'</a></li>';
                    }
                ?>
                <li class="breadcrumb-item text-dark"><?= $d->title ?></li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Page title=-->
        ...
        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
            ...
            <a href="dashboard" class="d-flex align-items-center">
                <img alt="Logo" src="<?= get_image('e_school_200.png') ?>" class="h-40px ms-3 image-fluid" />
            </a>
            <!--end::Logo-->
        </div>
        <!--end::Wrapper-->
                    ...
                    <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                        ...
                        <div data-kt-search-element="wrapper">
                            ...
                            <form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
                                ...
                                <!--end::Icon-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-flush ps-10" name="search" value="" placeholder="Buscar..." data-kt-search-element="input" />
                                <!--end::Input-->
                                <!--begin::Spinner-->
                            ...
                            <div class="mb-4" data-kt-search-element="main">
                                ...
                                <div class="d-flex flex-stack fw-bold mb-4">
                                    <!--begin::Label-->
                                    <span class="text-muted fs-6 me-2">Posibles busquedas:</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Items-->
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                <div class="fw-bolder d-flex align-items-center fs-5">Carlos Hurtado</div>
                                <a href="#" class="fw-bold text-muted text-hover-primary fs-7">carlos@gmail.com</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="logout" class="menu-link px-5">Salir</a>
                    </div>
                    <!--end::Menu item-->
                </div>
                <!--end::Menu-->
